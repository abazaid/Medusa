...
Write-Output "=== Updating Store Name to Arabic ==="
$update1 = Invoke-RestMethod -Uri "http://localhost:9000/admin/stores/$storeId" -Method Post -ContentType "application/json" -Headers @{Authorization="Bearer $token"} -Body '{"name":"متجري"}'
